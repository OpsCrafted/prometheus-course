...
```
{method="GET",endpoint="/",status="200"}  5
```

**Query 2:** `rate(http_requests_total[5m])`
```
{method="GET",endpoint="/",status="200"}  0.02  (5 requests / 300 seconds)
```
...
```
{method="GET",endpoint="/",status="200"}  0.0013  (5 requests / 3600 seconds)
```
